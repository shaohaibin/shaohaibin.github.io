...
[Check out TESTBED](/testbed/) <a href="/projects/"><img src="/assets/img/images/logo/logo-SILab.png" style="zoom:10%;"/></a>
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/swiper/1.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  ...
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/swiper/9.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
