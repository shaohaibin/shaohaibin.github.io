    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-dr-feiran-zhao-赵斐然-from-eth-delivered-a-talk-entitled-lqr-learning-pipelines-between-reinforcement-learning-and-adaptive-control",
          title: 'Dr. Feiran Zhao（赵斐然）from ETH delivered a talk entitled “LQR Learning Pipelines: Between Reinforcement...',
          description: "",
          section: "News",},{id: "news-汶川地震17年后-少年在交大圆了-报国梦",
          title: '汶川地震17年后，少年在交大圆了“报国梦”',
          description: "",
          section: "News",},{id: "news-祝贺陈雨昊-吕航论文-consensus-on-stochastic-higher-order-interaction-multi-agent-networks-被-ifac-2026-世界大会-釜山召开-录用",
          title: '祝贺陈雨昊、吕航论文《Consensus on Stochastic Higher-Order Interaction Multi-agent Networks》被 IFAC 2026 世界大会（釜山召开）录用！',
          description: "",
          section: "News",},{id: "news-实验室成功组织-ifac-world-congress-2026-invited-session-recent-advances-in-stochastic-multi-agent-systems-code-134dr-组织者-tao-li-中国科学院系统科学研究所-haibin-shao-上海交通大学-xiaofeng-zong-中国地质大学-aming-li-北京大学-shu-jun-liu-四川大学-lei-zou-东华大学-wenqi-cao-北京大学",
          title: '实验室成功组织 IFAC World Congress 2026 Invited session: Recent Advances in Stochastic Multi-agent Systems...',
          description: "",
          section: "News",},{id: "news-祝贺陈雨昊-龚晓辉论文-subspace-consensus-of-matrix-weighted-networks-被-65th-ieee-conference-on-decision-and-control-cdc-2026-honolulu-hawaii-召开-录用",
          title: '祝贺陈雨昊、龚晓辉论文《Subspace Consensus of Matrix-Weighted Networks》被 65th IEEE Conference on Decision and Control (CDC...',
          description: "",
